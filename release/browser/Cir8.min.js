var Cir8={Count:0,Pack:function(a){return new CPack(a)},Wire:function(a){return new CConduit({Name:a?a:"Wire"+Cir8.Count++})},Connect:function(a,b,c){a.Connect(b,c);b.Connect(a,c)},Dis:function(a,b,c){a.DisconnectWith(b,c);b.DisconnectWith(a,c)},Link:function(a,b,c,d){var e=new CConduit;this.Connect(a,e,b);this.Connect(d,e,c);return e}};function CComp(a){CComp.baseConstructor.call(this,a);this.Prop("Name",Date.now()+CComp.CCount++)}CComp.Count=0;Ctrl8.ExtendsTo(CComp);
CComp.prototype.Connect=function(a,b){};CComp.prototype.OnVibration=function(a,b,c){};CComp.prototype.DisconnectWith=function(a,b){};function C1Way(a){C1Way.baseConstructor.call(this,a);this._.Contacts={}}CComp.ExtendsTo(C1Way);C1Way.prototype.Connect=function(a,b){if("A"!==b&&"B"!==b)throw"Only contacts available are A and B";var c=this._.Contacts[b];c?c===a?1:c.Comp.Contact(a,b):this._.Contacts[b]=a};
C1Way.prototype.OnVibration=function(a,b,c){this._.Contacts.A===a&&this._.Contacts.B&&this._.Contacts.B.OnVibration(this,"B",c)};C1Way.prototype.DisconnectWith=function(a,b){this._.Contacts[b]&&(delete this._.Contacts[b],a.DisconnectWith(this,b))};function CConduit(a){CConduit.baseConstructor.call(this,a);this._.Contacts=[];this.Prop("ParallelTrx",!1);this.CalcProp("Signal",function(a,c){return null},function(a,c,d){this.OnVibration(null,null,a)})}CComp.ExtendsTo(CConduit);
CConduit.prototype.Connect=function(a,b){this._.Contacts.every(function(c){return c.Comp!==a||c.Contact!==b})?(this._.Contacts.push({Contact:b,Comp:a}),a.Connect(this,b)):0};CConduit.prototype.OnVibration=function(a,b,c){var d=this;this._.Contacts.forEach(function(e){if(e.Comp!==a||e.Contact!==b)d.ParallelTrx?setTimeout(CConduit.PVibrate,0,e.Comp,d,e.Contact,c):e.Comp.OnVibration(d,e.Contact,c)})};
CConduit.prototype.DisconnectWith=function(a,b){var c;this._.Contacts.every(function(d,e){c=e;return d.Comp!==a||d.Contact!==b})?1:(this._.Contacts.splice(c,1),a.DisconnectWith(this,b))};CConduit.PVibrate=function(a,b,c,d){a.OnVibration(b,c,d)};function CPort(a){CPort.baseConstructor.call(this,a);this._.Contacts={}}CComp.ExtendsTo(CPort);CPort.Get=function(a,b){var c=this._.Contacts[a];return c?c.v:void 0};CPort.Set=function(a,b,c){(c=this._.Contacts[b])&&c.c.OnVibration(this,b,a)};
