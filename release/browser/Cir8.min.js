...
CPack.prototype.OnVibration=function(a,b,c){0<=this.Ins.indexOf(b)&&(a=this._.HasInputs[b],this._.HasInputs[b]=1,this.Ports._.Contacts[b].v=c,void 0===a&&++this._.Collected==this.Ins.length?this.FX():1,this.Staged?this._.Collected>=this.Ins.length&&(this._.Collected=0,this._.HasInputs={}):a&&this._.Collected>=this.Ins.length?this.FX():1)};CPack.prototype.DisconnectWith=function(a,b){var c=this.Ports,d=c._.Contacts[b];d&&d.c==a&&(delete c._.Contacts[b],delete c[b],a.DisconnectWith(this,b))};
